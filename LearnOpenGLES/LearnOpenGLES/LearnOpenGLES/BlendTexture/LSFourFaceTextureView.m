...
#import "LSFourFaceTextureView.h"
#import <QuartzCore/QuartzCore.h>
#import <OpenGLES/ES2/gl.h>
#import <OpenGLES/ES2/glext.h>
#import "LSShaderTool.h"
@interface LSFourFaceTextureView ()
{
...
@implementation LSFourFaceTextureView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame]){
        ...
        //着色器程序
        _shaderProgram = [LSShaderTool getShaderWithVertexShaderFile:@"BlendTexture" fragmentShaderFile:@"BlendTexture"];
        ...
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);//临近插值
        ...
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);//不同的插值方式
