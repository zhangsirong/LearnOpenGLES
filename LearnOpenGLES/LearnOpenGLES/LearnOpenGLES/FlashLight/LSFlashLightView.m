...
@implementation LSFlashLightView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame]){
        ...
        //着色器程序
        _shaderProgram = [LSShaderTool getShaderWithVertexShaderFile:@"FlashLight" fragmentShaderFile:@"FlashLight"];
...
- (void)render:(CADisplayLink *)displayLink
{
    ...
    //设置光线
    glUniform3f(glGetUniformLocation(_shaderProgram, "light.ambient"),   0.1f, 0.1f, 0.1f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "light.diffuse"),   0.8f, 0.8f, 0.8f);
