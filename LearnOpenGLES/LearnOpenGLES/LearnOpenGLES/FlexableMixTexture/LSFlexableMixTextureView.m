...
#import "LSFlexableMixTextureView.h"
#import <QuartzCore/QuartzCore.h>
#import <OpenGLES/ES2/gl.h>
#import <OpenGLES/ES2/glext.h>
#import "LSShaderTool.h"
@interface LSFlexableMixTextureView ()
{
...
@implementation LSFlexableMixTextureView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame]){
        ...
        //着色器程序
        _shaderProgram = [LSShaderTool getShaderWithVertexShaderFile:@"FlexableMixTexture" fragmentShaderFile:@"FlexableMixTexture"];
...
{
    CGFloat greenValue = self.slider.value;
    NSLog(@"%f---%f",displayLink.timestamp,self.slider.value);
    GLint vertexColorLocation = glGetUniformLocation(_shaderProgram, [@"mixValue" UTF8String]);
...
{
    if (!_slider) {
        _slider = [[UISlider alloc] initWithFrame:CGRectMake(0, self.bounds.size.height - 50, self.bounds.size.width, 50)];
