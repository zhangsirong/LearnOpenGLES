...
const GLKVector3 cubePositions1[] = {
    { 0.0f,  0.0f,  0.0  },
    { 2.0f,  5.0f, -15.0 },
    {-1.5f, -2.2f, -2.5  },
    {-3.8f, -2.0f, -12.3 },
...
@implementation LSMore3DCubeView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame]){
        ...
        //着色器程序
        _shaderProgram = [LSShaderTool getShaderWithVertexShaderFile:@"More3DCube" fragmentShaderFile:@"More3DCube"];
...
- (void)render:(CADisplayLink *)displayLink
{
    ...
    for (GLuint i = 0; i < 10; i++) {
        GLKVector3 vector = cubePositions1[i];
        ...
        //动画旋转
        if(i % 3 == 0) {
            angle = displayLink.timestamp * 2.0;
        }
