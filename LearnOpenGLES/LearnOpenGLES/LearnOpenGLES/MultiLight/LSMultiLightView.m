...
@implementation LSMultiLightView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame]){
        ...
        //着色器程序
        _shaderProgram = [LSShaderTool getShaderWithVertexShaderFile:@"MultiLight" fragmentShaderFile:@"MultiLight"];
...
- (void)render:(CADisplayLink *)displayLink
{
    ...
    // 点光源 1
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[0].position"), pointLightPositions[0].x, pointLightPositions[0].y, pointLightPositions[0].z);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[0].ambient"), 0.05f, 0.05f, 0.05f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[0].diffuse"), 0.8f, 0.8f, 0.8f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[0].specular"), 1.0f, 1.0f, 1.0f);
    ...
    // 点光源 2
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[1].position"), pointLightPositions[1].x, pointLightPositions[1].y, pointLightPositions[1].z);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[1].ambient"), 0.05f, 0.05f, 0.05f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[1].diffuse"), 0.8f, 0.8f, 0.8f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[1].specular"), 1.0f, 1.0f, 1.0f);
    ...
    // 点光源 3
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[2].position"), pointLightPositions[2].x, pointLightPositions[2].y, pointLightPositions[2].z);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[2].ambient"), 0.05f, 0.05f, 0.05f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[2].diffuse"), 0.8f, 0.8f, 0.8f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[2].specular"), 1.0f, 1.0f, 1.0f);
    ...
    // 点光源 4
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[3].position"), pointLightPositions[3].x, pointLightPositions[3].y, pointLightPositions[3].z);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[3].ambient"), 0.05f, 0.05f, 0.05f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[3].diffuse"), 0.8f, 0.8f, 0.8f);
    glUniform3f(glGetUniformLocation(_shaderProgram, "pointLights[3].specular"), 1.0f, 1.0f, 1.0f);
