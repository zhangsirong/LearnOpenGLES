...
#import "LSSampleTransformationView.h"
...
@interface LSSampleTransformationView ()
{
...
@implementation LSSampleTransformationView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame]){
        ...
        //着色器程序
        _shaderProgram = [LSShaderTool getShaderWithVertexShaderFile:@"SampleTransformation" fragmentShaderFile:@"SampleTransformation"];
...
//    trans = GLKMatrix4Rotate(trans, M_PI_4, 0.0, 0.0, 1.0);
//    trans = GLKMatrix4Scale(trans, 0.5, 0.5, 0.5);
    trans = GLKMatrix4Rotate(trans, displayLink.timestamp * 2.0, 0.0, 0.0, 1.0);

    GLint uniformLocation = glGetUniformLocation(_shaderProgram, [@"transform" UTF8String]);
    glUniformMatrix4fv(uniformLocation, 1, GL_FALSE, trans.m);
